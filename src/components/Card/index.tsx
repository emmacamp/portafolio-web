...
export const Card = ({ title, text, icon, className, date }: CardProps) => (
    <div className={`card-component bg-white dark:bg-slate-800 rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl w-64  mt-10 mx-2 ${className}`}>
